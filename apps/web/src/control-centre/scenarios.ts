...
export const FAILURE_SCENARIOS: { id: FailureScenarioId; label: string; appliesTo: string }[] = [
  ...
  { id: 'identity_failure', label: 'Identity Failed', appliesTo: 'Forces the Kiosk face scan to not match — guest falls back to QR code check-in/out.' },
  ...
  { id: 'guest_lost_phone', label: 'Guest Lost Phone', appliesTo: 'Kiosk Check-In skips the face scan entirely and opens straight to reservation lookup.' },
