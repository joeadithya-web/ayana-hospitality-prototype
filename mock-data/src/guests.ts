...
const DEMO_PERSONAS: Guest[] = [
  ...
  },
  {
    ...
    memory: {
      ...
      interests: ['Family Activities', 'Culture & Heritage'],
      consent: { sharedWithHotels: true, lastUpdated: new Date('2026-05-02').toISOString() },
    },
    familyMembers: [
      { name: 'Kiran Nair', relationship: 'Spouse' },
      { name: 'Aanya Nair', relationship: 'Daughter' },
    ],
    previousStayIds: [],
    groupOrCorporateContext: null,
  ...
  },
  {
    ...
    memory: {
      ...
      businessOrLeisure: 'business',
      specialRequests: [],
      interests: ['Adventure', 'Wellness & Spa'],
  ...
  },
  {
    ...
    memory: {
      ...
      specialRequests: [],
      interests: [],
      consent: { sharedWithHotels: false, lastUpdated: new Date('2026-08-01').toISOString() },
    },
    familyMembers: [],
    previousStayIds: [],
    groupOrCorporateContext: null,
